...
Do not synthesize across papers. Do not perform Professor Reviewer work. Do not approve notes without checking against source full text. If full text is missing, mark the note as blocked and enforce the PDF/full-text gate.
